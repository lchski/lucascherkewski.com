...
I chose AngularJS to embark on this project, in large part thanks to my friend [Roy Sivan](http://www.roysivan.com)’s
...
I used [Tachyons](http://tachyons.io); it’s now my go-to for any project when I need to quickly design an interface.
